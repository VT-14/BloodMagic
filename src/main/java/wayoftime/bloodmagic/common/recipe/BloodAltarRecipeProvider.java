...
public class BloodAltarRecipeProvider implements ISubRecipeProvider
{
	...
	public void addRecipes(Consumer<IFinishedRecipe> consumer)
	{
		...
		BloodAltarRecipeBuilder.altar(Ingredient.fromTag(Tags.Items.ENDER_PEARLS), new ItemStack(BloodMagicItems.TELEPOSITION_FOCUS.get()), AltarTier.FOUR.ordinal(), 2000, 20, 10).build(consumer, BloodMagic.rl(basePath + "teleposer_focus"));
